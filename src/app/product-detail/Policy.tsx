...
const A_FEATURES = [
  {
    color: "bg-red-50",
    name: "Compra cualquier producto",
    desc: "Descuentos de hasta el 30%",
  ...
  {
    color: "bg-sky-50",
    name: "Fácil de devolver",
    desc: "A sólo una llamada.",
    svg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    color: "bg-green-50",
    name: "Envóos a todo el pais",
    desc: "Facilidad de envío a cualquier parte del pais.",
    svg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    desc: "Hasta 60 días para devolver tu producto.",
    svg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
